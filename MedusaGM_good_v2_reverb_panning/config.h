...
// ─── 2.42" OLED (SSD1309) over hardware I2C ─────────────────────────────────
...
// cost; the RP2350 at 250 MHz should manage it alongside 40 voices + the OLED,
// but if you hear crackle/dropouts set MEDUSA_FX to 0 (you keep stereo panning,
// you just lose the reverb/chorus).
